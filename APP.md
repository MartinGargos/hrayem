...
### 6.9 Event sharing
Every event has a **shareable deep link** (e.g. `https://hrayem.app/event/{id}`).
...
Before launch, deploy a simple static page at the deep link domain (e.g. `hrayem.app`) that:
